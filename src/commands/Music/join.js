...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
    ...
    if (player) {
      return await message.channel.send({ embeds: [new MessageEmbed().setColor(client.embedColor).setDescription(`I'm already connected to <#${player.player.voiceId}> voice channel!`)] })
    } else {
