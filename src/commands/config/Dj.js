  ...
  async run(client, ctx, args) {
    ...
    if (subCommand === "add") {
      ...
      if (isExRole)
        return await ctx.sendMessage({
          embeds: [
            embed.setDescription(`The dj role <@&${role.id}> is already added`),
          ],
        });
      ...
      return await ctx.sendMessage({
        embeds: [
          embed.setDescription(`The dj role <@&${role.id}> has been added`),
        ],
      });
      ...
      if (!isExRole)
        return await ctx.sendMessage({
          embeds: [
            embed.setDescription(`The dj role <@&${role.id}> is not added`),
          ],
        });
      client.db.removeRole(ctx.guild.id, role.id);
      return await ctx.sendMessage({
        embeds: [
          embed.setDescription(`The dj role <@&${role.id}> has been removed`),
        ],
      });
        ...
        return await ctx.sendMessage({
          embeds: [
            embed.setDescription(
              `The dj mode has been toggled to ${
