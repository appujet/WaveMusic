...
const { checkDj } = require("../player/TrackStart.js");

module.exports = class SetupButtons extends Event {
  ...
  async run(interaction) {
    ...
    if (
      ...
      interaction.guild.members.cache.get(this.client.user.id).voice
      ...
      .setDescription(
        `[${title}](${uri}) - ${
          player.current.info.isStream
            ? "LIVE"
            : this.client.utils.formatTime(length)
