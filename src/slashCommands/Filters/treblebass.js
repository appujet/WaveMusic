    ...
    collector.on("collect", async (b) => {
      ...
      if (b.customId === "clear_but") {
        ...
        return await b.editReply({
          embeds: [
            embed1.setDescription(`${emojiequalizer} TrebleBass Mode Is \`OFF\``),
          ],
          components: [row2],
        });
        ...
        var bands = [
          ...
          await player.setEQ(...bands);        return await b.editReply({
          embeds: [
            embed1.setDescription(`${emojiequalizer} TrebleBass Mode Is \`ON\``),
          ],
          components: [row1],
        });
      }
